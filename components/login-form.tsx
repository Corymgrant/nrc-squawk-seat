    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Use the account Cory set up for you.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleLogin}>
            <div className="flex flex-col gap-6">
              <div className="grid gap-2">
                ...
                <Input id="email" type="email" placeholder="you@norepaircost.com" required value={email} onChange={(e) => setEmail(e.target.value)} />
              </div>
              <div className="grid gap-2">
