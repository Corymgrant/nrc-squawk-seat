...
// job 1941: Closed-Loop ROAS panel (ADR-479 gap-panel #5) — read-only rollup;
// does not touch the live n8n Closed-Loop ROAS workflow (ENRXZKwEHOmeRB4G).
